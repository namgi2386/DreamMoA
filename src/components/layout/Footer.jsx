...
const ConstellationFooter = () => {
  ...
  const [userDeterminations, setUserDeterminations] = useState([
    { id: 1, text: "의사가 되고 싶어요", x: 30, y: 40 },
    { id: 2, text: "영어 시험 900점!", x: 60, y: 70 },
    { id: 3, text: "프로그래머 되기", x: 20, y: 80 }
  ]);

  // 메뉴 별자리 연결 선
  const renderConstellationLines = () => (
    <svg className="absolute inset-0 pointer-events-none">
      <line x1="30%" y1="40%" x2="60%" y2="70%" stroke="#F5CBA7" strokeWidth="2" opacity="0.5" />
      <line x1="60%" y1="70%" x2="20%" y2="80%" stroke="#F5CBA7" strokeWidth="2" opacity="0.5" />
      <line x1="20%" y1="80%" x2="30%" y2="40%" stroke="#F5CBA7" strokeWidth="2" opacity="0.5" />
    </svg>
  );
  ...
  return (
    <footer 
      ...
      style={{ 
        backgroundImage: 'radial-gradient(ellipse at center, rgba(30,31,38,1) 0%, rgba(15,15,20,1) 100%)'
      }}
    >
